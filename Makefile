...
# Project Sources
SRC = src/main.mm src/AudioEngine.cpp src/Oscillator.cpp src/Voice.cpp src/SynthEngine.cpp src/Envelope.cpp src/Filter.cpp src/MidiManager.cpp src/PresetManager.cpp src/Renderer.mm
OBJ = $(SRC:.cpp=.o)
OBJ := $(OBJ:.mm=.o)
